...
pub enum CreateTableOption {
    Engine { span: Span, is_equal: bool, engine_name: String },
    SecondaryEngine { span: Span, is_equal: bool, engine_name: Option<String> },
    MaxRows { span: Span, is_equal: bool, value: String },
    MinRows { span: Span, is_equal: bool, value: String },
    AvgRowLength { span: Span, is_equal: bool, value: String },
    Password { span: Span, is_equal: bool, content: String },
    Comment { span: Span, is_equal: bool, content: String },
    Compression { span: Span, is_equal: bool, value: String },
    Encryption { span: Span, is_equal: bool, value: String },
    AutoInc { span: Span, is_equal: bool, value: String },
    PackKeys { span: Span, is_equal: bool, option: Ternary },
    StatsAutoRecalc { span: Span, is_equal: bool, option: Ternary },
    StatsPersistent { span: Span, is_equal: bool, option: Ternary },
    StatsSamplePages { span: Span, is_equal: bool, is_default: bool, value: Option<String> },
    Checksum { span: Span, is_equal: bool, value: String },
    TableChecksum { span: Span, is_equal: bool, value: String },
    DelayKeyWrite { span: Span, is_equal: bool, value: String },
    RowFormat { span: Span, is_equal: bool, row_types: RowTypes },
    Union { span: Span, is_equal: bool, opt_table_list: Option<Vec<TableIdent>> },
    DefaultCharset(DefaultCharset),
    DefaultCollation(DefaultCollation),
    InsertMethod { span: Span, is_equal: bool, merge_insert_types: MergeInsertTypes },
    DataDirectory { span: Span, is_equal: bool, value: String },
    IndexDirectory { span: Span, is_equal: bool, value: String },
    Tablespace { span: Span, is_equal: bool, value: String },
    StorageDisk,
    StorageMemory,
    Connection { span: Span, is_equal: bool, value: String },
    KeyBlockSize { span: Span, is_equal: bool, value: String },
    StartTransaction,
    EngineAttribute { span: Span, is_equal: bool, json_attribute: String },
    SecondaryEngineAttribute { span: Span, is_equal: bool, json_attribute: String },
...
pub enum PartitionOption {
    Tablespace { span: Span, is_equal: bool, tablespace_name: String },
    Engine { span: Span, is_storage: bool, is_equal: bool, engine_name: String },
    NodeGroup { span: Span, is_equal: bool, group_num: String },
    MaxRows { span: Span, is_equal: bool, rows_num: String },
    MinRows { span: Span, is_equal: bool, rows_num: String },
    DataDirectory { span: Span, is_equal: bool, data_dir: String },
    IndexDirectory { span: Span, is_equal: bool, index_dir: String },
    Comment { span: Span, is_equal: bool, comment: String },
}
...
pub enum SRSAttribute {
    Name { span: Span, srs_name: String },
    Definition { span: Span, definition: String },
    Organization { span: Span, org_name: String, org_id: String },
    Description { span: Span, description: String },
}
