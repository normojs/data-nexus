...
// 升级
// %expect-unused explicit_table and opt_duplicate opt_alter_tablespace_options
// %expect-unused alter_tablespace_option_list alter_tablespace_option opt_alter_logfile_group_options
// %expect-unused alter_logfile_group_option_list alter_logfile_group_option undo_tablespace_state 'NEG_PREC'
// %expect-unused  'EMPTY_FROM_CLAUSE' 'CONDITIONLESS_JOIN' 'SUBQUERY_AS_EXPR' 'LOWER_THEN_INTERVAL' 'LOWER_THEN_TEXT_STRING' 'LOWER_THEN_SAVEPOINT' 'LOWER_THEN_COMMA' 'AND_AND'
...
sql_stmt -> SqlStmt:
  ...
  | show_table_status_stmt { SqlStmt::ShowTableStatusStmt($1) }
...
;
show_table_status_stmt -> Box<ShowTableStatusStmt>:
    'SHOW' 'TABLE' 'STATUS' opt_wild_or_where
    {
        Box::new(ShowTableStatusStmt {
           span: $span,
           opt_wild_or_where: $4,
        })
    }
