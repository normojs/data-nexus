...
1. **A10** backend 真游标 hold（可选；逻辑 skip 已交付）  
2. **A08** extended TCP bind 帧中继（可选）  
3. **H05** CRDT / mlock（可选；Zeroizing 副本已交付）  
4. **A06** 精密 cgroup/RSS 字节级 CI（可选；粗粒度 stream-rss 已有）  
